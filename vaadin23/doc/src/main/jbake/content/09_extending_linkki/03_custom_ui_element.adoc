...
|===
|`AvailableValuesAspectDefinition`| Defines an aspect that updates the set of available values of https://vaadin.com/api/platform/22.0.1/com/vaadin/flow/data/provider/HasListDataView.html[HasListDataView].
