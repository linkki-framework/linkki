:jbake-title: Vaadin 23 Migration
:jbake-type: chapter
:jbake-status: published
:jbake-order: 1000

:source-dir-v14: ../../../../../../vaadin23/samples/test-playground/src/main/java/org/linkki/samples/playground/
...
////
==== Theming
Valo theme has been replaced by Lumo theme. The Lumo Theme is default and there is no @Theme annotation required since vaadin23.  For more information see https://vaadin.com/docs/flow/migration/6-theming.html
