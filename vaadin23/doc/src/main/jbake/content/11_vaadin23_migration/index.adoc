...
Valo theme has been replaced by Lumo theme. The Lumo Theme is default and there is no @Theme annotation required. For more information see https://vaadin.com/docs/flow/migration/6-theming.html
