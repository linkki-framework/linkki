...
* with name and a `Class` to navigate to. The given class should be a <<vaadin23-migration-views, route component>>. 
...
This behavior has changed with Vaadin 23. All sections now have a fixed label width by default. It is not possible to have dynamic label width anymore.
