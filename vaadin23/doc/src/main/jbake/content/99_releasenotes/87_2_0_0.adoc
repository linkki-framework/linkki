...
|=== 
| Changes | Description
| `org.linkki.core.vaadin.component.section.AbstractSection` a| Has been removed and replaced by `org.linkki.core.vaadin.component.section.LinkkiSection`.
| `org.linkki.core.vaadin.component.section.LinkkiSection` a| New concrete class. Replacement for `org.linkki.core.vaadin.component.section.AbstractSection`. Corresponding code has been moved.
| `org.linkki.core.vaadin.component.section.BaseSection.getSectionContent()` a| Deprecated. Use `org.linkki.core.vaadin.component.section.BaseSection.getContentWrapper()` instead.
| `org.linkki.core.vaadin.component.section.GridSection.getSectionContent()` a| Deprecated. Use `org.linkki.core.vaadin.component.section.GridSection.getGrid()` instead.
|===

This also results in changes of the HTML structure of sections which are now furthermore `linkki-section` instead of `vaadin-vertical-layouts`. This must be considered when using selectors in UI tests or CSS styling.
