...
A new aspect `@BindPlaceholder` has been introduced. With the aspect, a placeholder can be added to UI elements to display a text, while the UI element is empty. See documentation of <<placeholder, @BindPlaceholder>> for further information.
