...
/**
 * {@link StaticModelToUiAspectDefinition} that sets an {@link Element}'s attribute to a value. Useful
 * when implementing {@link AspectDefinitionCreator}s which manipulate attributes of elements.
 */
public class ElementAttributeAspectDefinition extends StaticModelToUiAspectDefinition<String> {
    ...
    /**
     * Creates an {@link ElementAttributeAspectDefinition} that sets an {@link Element}'s attribute to a
     * value.
     * 
