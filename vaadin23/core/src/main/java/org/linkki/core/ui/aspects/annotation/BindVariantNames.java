...
/**
 * This aspect sets one or multiple Vaadin defined variant names using {@link HasTheme#addThemeName(String)}.
 */
@Retention(RUNTIME)
...
public @interface BindVariantNames {
    ...
    /**
     * The variant names are defined across different variant enums, such as {@link GridVariant}. Multiple
     * variant names can be provided as an array:
