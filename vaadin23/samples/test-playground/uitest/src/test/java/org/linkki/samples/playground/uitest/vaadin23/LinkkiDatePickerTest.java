...
public class LinkkiDatePickerTest extends AbstractUiTest {
    ...
    public void testNoDotsShort() {
        ...
        assertThat(datePicker.getDate(), is(LocalDate.of(2020, 1, 3)));
    }
    ...
    public void testNoDotsLong() {
        ...
        assertThat(datePicker.getDate(), is(LocalDate.of(1850, 7, 5)));
    }
    ...
    public void testDotsShort() {
        ...
        assertThat(datePicker.getDate(), is(LocalDate.of(1973, 4, 6)));
    }
    ...
    public void testDotsLong() {
        ...
        assertThat(datePicker.getDate(), is(LocalDate.of(2232, 8, 7)));
    }
