...
public class PropertyElementDescriptorsTest {
    ...
    @LinkkiBindingDefinition(AnotherTestFieldBindingDefinition.class)
    @LinkkiAspect(AnotherTestUIField.Creator.class)
    public @interface AnotherTestUIField {
        ...
        class Creator implements LinkkiAspect.Creator<AnotherTestUIField> {
