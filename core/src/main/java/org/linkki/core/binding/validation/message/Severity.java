...
public enum Severity {
    ...
    /**
     * Indicates that the {@link Message} contains nothing alarming but is purely informative in
     * nature.
     */
    INFO,

    /**
     * Indicates that the user should be warned about the content of the {@link Message}. A
     * confirmation may be needed before the procedure that produced the {@link Message} continues.
     */
    WARNING,
