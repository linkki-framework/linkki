...
public class TableBinding<@NonNull T> extends BindingContext implements Binding {
    ...
    TableBinding(Handler modelChanged, PropertyBehaviorProvider behaviorProvider,
        ...
        bind(containerPmo, new SimpleBindingDescriptor("", TableAspectDefinitions.createAll()), tableComponentWrapper);
    }
    ...
    /**
     * Creates a new {@link TableBinding} and adds the new binding to the given {@link BindingContext}.
     *
