...
public interface PropertyBehavior {
     ...
     * <p>
     * The writable state of the behavior is determined by the given supplier independent of the
     * bound object and property passed to {@link #isWritable(Object, String)}.
     * 
     * @param writableStateSupplier a supplier for the current writable state
     * @return a new {@link PropertyBehavior} that implements {@link #isWritable(Object, String)}
     *         with a redirection to the given supplier
     * 
     ...
     * @return a new {@link PropertyBehavior} that implements {@link #isWritable(Object, String)}
     *         with a redirection to the given predicate
     * 
     ...
     * <p>
     * The writable state of the behavior is determined by the given supplier independent of the
     * bound object and property passed to {@link #isWritable(Object, String)}, negating its return
     * value to better fit the read-only semantic.
     * <p>
     ...
     * @return a new {@link PropertyBehavior} that implements {@link #isWritable(Object, String)}
     *         with a redirection to the negation of given supplier
     * 
     * @see PropertyBehavior#readOnly(BiPredicate)
     * @see PropertyBehavior#readOnly()
     * @see PropertyBehavior#writable(BooleanSupplier)
     ...
     * <p>
     * The writable state of the behavior is determined by the given predicate, passing it the bound
     * object and property passed to {@link #isWritable(Object, String)}, negating its return value
     * to better fit the read-only semantic.
     * <p>
     * A property is considered to be read-only exactly if it's not writable.
     * 
     ...
     * @return a new {@link PropertyBehavior} that implements {@link #isWritable(Object, String)}
     *         with a redirection to the negation of given predicate
     * 
     * @see PropertyBehavior#readOnly(BooleanSupplier)
     * @see PropertyBehavior#readOnly()
     * @see PropertyBehavior#writable(BiPredicate)
     ...
     * <p>
     * The visible state of the behavior is determined by the given supplier independent of the
     * bound object and property passed to {@link #isVisible(Object, String)}.
     * 
     * @param visibleStateSupplier a supplier for the current visible state
     * @return a new {@link PropertyBehavior} that implements {@link #isVisible(Object, String)}
     *         with a redirection to the given supplier
     * 
     ...
     * <p>
     * The visible state of the behavior is determined by the given supplier independent of the
     * bound object and property passed to {@link #isShowValidationMessages(Object, String)}.
     * 
     * @param showValidationMessagesStateSupplier a supplier for the current validation-message
     *            state
     ...
     * 
     * @param showValidationMessagesPredicate a method deciding for a given bound object/property
     *            pair whether messages for the property should be shown
     * @return a new {@link PropertyBehavior} that implements
     *         {@link #isShowValidationMessages(Object, String)} with a redirection to the given
     *         predicate
     * 
