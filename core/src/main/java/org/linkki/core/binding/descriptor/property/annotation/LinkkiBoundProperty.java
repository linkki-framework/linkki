 ...
 * annotation.
 * <p>
 * The default {@link BoundPropertyCreator} is {@link ModelBindingBoundPropertyCreator} which uses
 * the property name of the annotated element (normally the method in a PMO) and defines a model
 * binding using the annotation properties which are annotated with {@link ModelObjectProperty} and
...
public @interface LinkkiBoundProperty {
    ...
    /**
     * Annotation that marks the {@code modelObject} property within an annotation that is marked
     * with {@link LinkkiBoundProperty}.
     *
     * @deprecated This annotation has a naming conflict with
     *             {@link org.linkki.core.pmo.ModelObject}, use {@link ModelObjectProperty} instead.
     */
