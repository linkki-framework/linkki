...
/**
 * An observer that can be attached to a {@link BindingManager} and is notified if an update UI event is
 * triggered by a managed {@link BindingContext}. Updates its own UI upon notification.
 * 
