...
/**
 * Invoke aspect binding that is only used if the component is an instance of {@link Button}. The
 * {@link Bind} annotation could be used with different kind of fields, hence we do not want to
