...
/**
 * Shows a tooltip for a UI component. The annotation can be added to the method bound to a UI field
 * or to a class bound to a section, where the tooltip is shown on the header.
 */
