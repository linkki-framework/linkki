...
/**
 * A simple utility class that uses the {@link UIElementAnnotationReader} to find UI element annotations
 * and creates the defined components. The caller is responsible for adding the component to a
 * surrounding UI component and for returning a {@link ComponentWrapper} that could be handled over to
