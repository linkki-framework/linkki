...
public class Sections {
     ...
     * 
     * @implNote uses a PMO method annotated with {@link SectionID @SectionID} if present and
     *           defaults to the {@link Class#getSimpleName() simple name} of the PMO class.
    ...
    /**
     * Returns the {@link ButtonPmo} for the edit button of the section created from the
     * presentation model object if one is defined.
     * 
