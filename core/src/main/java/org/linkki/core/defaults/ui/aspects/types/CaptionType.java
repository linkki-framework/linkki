...
public enum CaptionType {
    ...
    /**
     * Linkki decides whether the caption is {@link #DYNAMIC} or {@link #STATIC}. In case the value
     * is the empty string it calls a method named {@code get<PropertyName>Caption()}. Otherwise the
