...
public enum IconType {
    ...
    /**
     * Linkki decides whether the icon is {@link #DYNAMIC} or {@link #STATIC}. In case the value is
     * the default value it calls a method named {@code get<PropertyName>Icon()}. Otherwise the
     * specified value is used as icon.
     */
    AUTO;
}
