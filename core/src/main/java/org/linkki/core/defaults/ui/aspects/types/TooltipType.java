...
public enum TooltipType {
    ...
    /**
     * Linkki decides whether the tooltip is {@link #DYNAMIC} or {@link #STATIC}. In case the value is
     * the empty string it calls a method named {@code get<PropertyName>Tooltip()}. Otherwise the
