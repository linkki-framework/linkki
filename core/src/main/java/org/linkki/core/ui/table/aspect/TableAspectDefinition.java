...
public abstract class TableAspectDefinition<@NonNull T, V> extends ModelToUiAspectDefinition<V> {

    private final String name;
    private final BiConsumer<TableComponentWrapper<T>, V> valueSetter;


    public TableAspectDefinition(String name, BiConsumer<TableComponentWrapper<T>, V> valueSetter) {
        super();
        this.name = name;
    ...
    public Consumer<V> createComponentValueSetter(ComponentWrapper componentWrapper) {
        return v -> valueSetter.accept((TableComponentWrapper<T>)componentWrapper, v);
    }
