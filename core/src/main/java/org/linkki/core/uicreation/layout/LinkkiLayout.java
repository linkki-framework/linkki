 ...
 * client code, for example a PMO class. This might be a UI section annotation but could also be a
 * new annotation that simply defines how components are positioned.
 */
@Retention(RUNTIME)
