...
Custom layout does not directly define the layout but gives the ability to create a HTML file containing the exact position of each control. Therefore it uses the https://vaadin.com/docs/v7/framework/layout/layout-customlayout.html[CustomLayout] from vaadin.
