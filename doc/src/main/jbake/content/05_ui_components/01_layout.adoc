...
* In a `@UISection`, the required indicator is shown on the right of the input field. In a `@UIFormSection`, the required indicator is shown on the right of the label.
+
image::{images}{images-folder-name}/uisection-required.png[Required indicator in @UISection,align="center"]
+
image::{images}{images-folder-name}/uiformsection-required.png[Required indicator in an @UIFormSection,align="center"]
