...
To use this feature, the UI needs to be created via <<pmo-uisection,`@UISection`>>, and the instance field or the getter method for the model object in the PMO needs to be marked with the `@ModelObject` annotation:
