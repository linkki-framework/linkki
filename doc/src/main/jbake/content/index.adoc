...
:images-index: ../../../src/main/jbake/assets/images/content/
...
=== Demo Application and Sampler

The demo application manages business partner data for a company.

The *linkki* sampler gives an overview on the built-in UI
components.
