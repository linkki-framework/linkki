...
Then, the data binding can be created via the {github-blob}/core/src/main/java/org/linkki/core/binding/Binding.java[`Binder`].
...
You can find a sample project with the different binding options on {github-tree}/samples/binding[GitHub].
