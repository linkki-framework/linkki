...
image::{images-03_architektur}data_binding.png[]
...
image::{images-03_architektur}binding_context_manager.png[]
...
image::{images-03_architektur}pmo.png[]
...
.Model Binding
image::{images-03_architektur}ModelBinding.png[]
...
image::{images-03_architektur}vertical_binding.png[]
...
image::{images-03_architektur}property_behavior_veto.png[]
