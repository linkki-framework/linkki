...
:image-dir: ../../../src/main/jbake/assets/images/content/09_nls
...
The first entry of the above `.properties` file points to the PMO `ContactRowPmo`, and provides an English translation for the label of its property `name`:
