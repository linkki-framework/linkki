...
==== Package Umzug für PropertyBehavior

Die Klasse `PropertyBehavior` ist vom Package `org.linkki.core.binding.aspect` nach `org.linkki.core.binding.behavior` umgezogen.
