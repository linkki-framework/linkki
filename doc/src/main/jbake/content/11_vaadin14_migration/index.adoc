...
* ApplicationConfig#createApplicationLayout und ApplicationLayout#createApplicationNavigator wurden entfernt
...
* Sidebar und TabLayout wurden vereinheitlicht (LIN-2158)
