...
public class ButtonPmoBuilder {
    ...
    public static ButtonPmo newEditButton(Handler onClickAction) {
        return ButtonPmoBuilder.action(onClickAction).icon(FontAwesome.PENCIL).get();
    }
    ...
    public static ButtonPmo newAddButton(Handler onClickAction) {
        return ButtonPmoBuilder.action(onClickAction).icon(FontAwesome.PLUS).get();
    }
    ...
    public static ButtonPmo newDeleteButton(Handler onClickAction) {
        return ButtonPmoBuilder.action(onClickAction).icon(FontAwesome.TRASH_O).get();
    }
