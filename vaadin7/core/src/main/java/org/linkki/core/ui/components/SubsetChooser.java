 ...
 * behavior for obtaining item captions, namely to use an {@link #getItemCaptionProvider() item caption
 * provider} function when an item's caption is needed. As an additional bonus "subset chooser" is a
 * much nicer name for a multi-select component with a left and right list.
 */
