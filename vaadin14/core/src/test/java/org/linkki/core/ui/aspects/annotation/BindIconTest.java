...
public class BindIconTest {
    ...
    public void testCreateAspect_Dynamic() {
        ...
        Aspect<Resource> aspect = linkkiAspectDefinition.createAspect();
    ...
    public void testCreateAspect_AutoStaticIcon() {
        ...
        assertThat(aspect.getValue(), is(VaadinIcons.ABACUS));
        assertThat(aspect.getName(), is(IconAspectDefinition.NAME));
    }
    ...
    public void testCreateAspect_NativeButton() {
        ...
        assertThat(aspect.getValue(), is(VaadinIcons.NATIVE_BUTTON));
        assertThat(aspect.getName(), is(IconAspectDefinition.NAME));
    }

    @BindIcon(value = VaadinIcons.ABSOLUTE_POSITION, iconType = IconType.STATIC)
    @Test
    public void testCreateAspect_Static() {
        ...
        assertThat(aspect.getValue(), is(VaadinIcons.ABSOLUTE_POSITION));
        assertThat(aspect.getName(), is(IconAspectDefinition.NAME));
    }
