...
package org.linkki.samples.playground.locale;
...
public class LocaleInfoPage extends Div {

    private static final long serialVersionUID = 1L;

    public LocaleInfoPage() {
        add(VaadinUiCreator.createComponent(new LocalePmo(), new BindingContext()));
    }

    @UISection(caption = "Locale")
    public static class LocalePmo {
        ...
        @UIButton(position = 20, caption = "Close Session")
