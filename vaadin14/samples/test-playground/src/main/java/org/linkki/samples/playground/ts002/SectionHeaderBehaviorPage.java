...
public class SectionHeaderBehaviorPage extends AbstractPage {

    private static final long serialVersionUID = 4913196258806885693L;

    private final BindingContext bindingContext;

    public SectionHeaderBehaviorPage() {
    ...
    public void createContent() {
        ...
        testCasesTabs.addTabSheets(
                                   LinkkiTabSheet.builder("TC001")
                                           .content(new TestCaseSection("TS002.TC001",
                                                   VaadinUiCreator.createComponent(new SectionHeaderBehaviorPmo(),
                                                                                   getBindingContext())))
                                           .build());
