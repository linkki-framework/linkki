...
[source, java]
----
include::{source-dir}/org/linkki/samples/playground/binding/components/AddressComponent.java[tags=declaration]

include::{source-dir}/org/linkki/samples/playground/binding/components/AddressComponent.java[tags=methods]
----
