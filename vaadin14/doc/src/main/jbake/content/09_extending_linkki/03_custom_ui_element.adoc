...
|===
|`AvailableValuesAspectDefinition`| Defines an aspect that updates the set of available values of https://vaadin.com/api/platform/14.7.8/com/vaadin/flow/data/binder/HasItems.html[HasItems].
