...
////
`F10Styles.TABLE_FOOTER_DECIMAL_SUM` has been replaced. Use `LinkkiApplicationTheme#GRID_FOOTER_SUM` now in `@BindStyleNames` annotated table PMOs to make table footer text bold and right aligned.
