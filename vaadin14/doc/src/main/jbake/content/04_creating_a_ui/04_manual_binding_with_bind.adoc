...
You can find a sample project with the different binding options on {github-tree}/vaadin14/samples/test-playground/src/main/java/org/linkki/samples/playground/binding[GitHub].
