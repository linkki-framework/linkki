...
:source-dir-messages: ../../../../../../vaadin14/samples/test-playground/src/main/java
...
[source, java]
----
include::{source-dir-messages}/org/linkki/samples/playground/messages/MessagesComponent.java[tags=validation-service]
----