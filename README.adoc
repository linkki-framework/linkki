...
image:https://maven-badges.herokuapp.com/maven-central/org.linkki-framework/linkki-core-vaadin14/badge.svg[Maven Central, link=https://mvnrepository.com/artifact/org.linkki-framework/linkki-core-vaadin14, role="left"]
