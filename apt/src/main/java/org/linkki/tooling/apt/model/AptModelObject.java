...
public class AptModelObject {
    ...
    private final Either<? extends VariableElement, ? extends ExecutableElement> element;
    ...
    public AptModelObject(ModelObject annotation, AnnotationMirror annotationMirror,
            Either<? extends VariableElement, ? extends ExecutableElement> element, TypeMirror type,
    ...
    public Either<? extends VariableElement, ? extends ExecutableElement> getElement() {
        return element;
    }
