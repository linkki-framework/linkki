...
import org.linkki.tooling.validator.AvailableValuesTypeValidator;
import org.linkki.tooling.validator.DynamicFieldValidator;
import org.linkki.tooling.validator.ModelBindingValidator;
import org.linkki.tooling.validator.ModelObjectValidator;
...
public class SuppressedWarningsTest extends BaseAnnotationProcessorTest {
    ...
    class CompilationSuccess {
        ...
        void shouldSucceedWhenMissingEnabledMethodErrorIsSuppressed() throws IOException {
            ...
            addOption(AspectMethodValidator.MISSING_METHOD_ABSTRACT_TYPE, Kind.WARNING.name());
        ...
        private DynamicNode testFileIsOk(FileToCode it) {
            return dynamicTest(it.getFile(), () -> {
                setUp();
                addOption(it.getCode(), Kind.WARNING.name());
