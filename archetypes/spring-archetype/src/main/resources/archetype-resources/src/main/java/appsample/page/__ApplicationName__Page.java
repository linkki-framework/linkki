package \${package}.appsample.page;
...
import ${package}.appsample.pmo.HelloPmo;
...
public class \${ApplicationName}Page extends AbstractPage {
    ...
    public void createOwnDialog() {
        ...
        ConfirmationDialog dialog = new ConfirmationDialog("Now try to create your own linkki Web Application!", null,
                handler);
