...
[source,java]
----
include::{source-dir}/org/linkki/samples/playground/application/SampleApplicationUI.java[tags=application-sample-ui]
----
...
[source,java]
----
include::{source-dir}/org/linkki/samples/playground/application/MainView.java[tags=sidebar-addSheet]
----

[source,java]
----
include::{source-dir}/org/linkki/samples/playground/application/MainView.java[tags=sidebar-createReportLayout]
----
...
[source,java]
----
include::{source-dir}/org/linkki/samples/playground/application/MainView.java[tags=addHeadline-call]
----
