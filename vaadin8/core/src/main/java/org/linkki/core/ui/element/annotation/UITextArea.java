...
import org.linkki.core.ui.element.annotation.UITextArea.TextAreaBoundPropertyCreator;
...
@LinkkiBoundProperty(TextAreaBoundPropertyCreator.class)
...
public @interface UITextArea {
    ...
    static class TextAreaBoundPropertyCreator implements BoundPropertyCreator<UITextArea> {

        @Override
        public BoundProperty createBoundProperty(UITextArea annotation, AnnotatedElement annotatedElement) {
    ...
    static class TextAreaComponentDefinitionCreator implements ComponentDefinitionCreator<UITextArea> {
        ...
        public LinkkiComponentDefinition create(UITextArea annotation, AnnotatedElement annotatedElement) {
            return pmo -> ComponentFactory.newTextArea(annotation.maxLength(), annotation.width(), annotation.rows());
        }
    }
