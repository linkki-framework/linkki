...
import org.linkki.core.ui.element.annotation.UIYesNoComboBox.YesNoComboBoxBoundPropertyCreator;
...
@LinkkiBoundProperty(YesNoComboBoxBoundPropertyCreator.class)
...
public @interface UIYesNoComboBox {
    ...
    static class YesNoComboBoxBoundPropertyCreator implements BoundPropertyCreator<UIYesNoComboBox> {

        @Override
        public BoundProperty createBoundProperty(UIYesNoComboBox annotation, AnnotatedElement annotatedElement) {
