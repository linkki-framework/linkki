 ...
 *           {@link LinkkiApplicationStyles#APPLICATION_HEADER}. The right aligned {@link MenuBar} uses the style
 *           name {@link LinkkiApplicationStyles#APPLICATION_HEADER_RIGHT} additionally.
 * 
...
public class ApplicationHeader extends HorizontalLayout {
    ...
    public ApplicationHeader(ApplicationMenu applicationMenu) {
        ...
        addStyleName(LinkkiApplicationStyles.APPLICATION_HEADER);
        setWidth("100%");
    ...
    protected void addRightComponents() {
        ...
        wrapper.setStyleName(LinkkiApplicationStyles.APPLICATION_HEADER_RIGHT);
