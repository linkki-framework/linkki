...
class InfoToolsComponentTest {
    ...
    @Test
    void testPolicyToolsArea_NoTools() {
    ...
    @Test
    void testPolicyToolsArea_SomeTools() {
    ...
    @Test
    void testPolicyToolsArea_DefaultOpened() {
        var component1 = new Div();
        var component2 = new Div();
    ...
    @Test
    void testPolicyToolsArea_ToolSpecifiedInUrlOpened() {
        var component1 = new Div();
        var component2 = new Div();
    ...
    @Test
    void testPolicyToolsArea_AllToolsClosed() {
        var component1 = new Div();
        var component2 = new Div();
        var component3 = new Div();
        var infoTool1 = new InfoTool("id1", "Caption1", component1);
