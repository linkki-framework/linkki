...
public class AvailableValuesSectionPmo {
    ...
    @UIComboBox(position = 10,
            ...
            modelAttribute = IpsModelObject.PROPERTY_INTEGERENUMERATIONVALUESET)
    public void integerEnumerationValueSet() {
        // model binding
    }

    @UIRadioButtons(position = 11,
            content = AvailableValuesType.ENUM_VALUES_INCL_NULL,
            modelAttribute = IpsModelObject.PROPERTY_INTEGERENUMERATIONVALUESET)
    ...
    @UIComboBox(position = 20,
            content = AvailableValuesType.ENUM_VALUES_INCL_NULL,
            modelAttribute = IpsModelObject.PROPERTY_ENUMERATIONVALUESET)
    public void enumerationValueSet() {
        // model binding
    }

    @UIRadioButtonGroup(position = 21,
            content = AvailableValuesType.ENUM_VALUES_INCL_NULL,
            modelAttribute = IpsModelObject.PROPERTY_ENUMERATIONVALUESET)
    ...
    @UIComboBox(position = 30,
            content = AvailableValuesType.ENUM_VALUES_INCL_NULL,
            modelAttribute = IpsModelObject.PROPERTY_INTEGERRANGEVALUESET)
    ...
    @UIComboBox(position = 40,
            content = AvailableValuesType.ENUM_VALUES_INCL_NULL,
            modelAttribute = IpsModelObject.PROPERTY_BOOLEANVALUESET)
    public void booleanValueSet() {
        // model binding
    }

    @UIRadioButtonGroup(position = 50,
            content = AvailableValuesType.ENUM_VALUES_INCL_NULL,
            modelAttribute = IpsModelObject.PROPERTY_BOOLEANVALUESET)
    ...
    @UIComboBox(position = 70,
            content = AvailableValuesType.ENUM_VALUES_INCL_NULL,
            modelAttribute = IpsModelObject.PROPERTY_EMPTYSTRINGVALUESET,
            visible = VisibleType.DYNAMIC,
            enabled = EnabledType.DYNAMIC,
            label = "Empty String ValueSet should show an empty ComboBox")
        ...
        new PmoBasedDialogFactory(ValidationService.NOP_VALIDATION_SERVICE,
                PropertyBehaviorProvider.NO_BEHAVIOR_PROVIDER, new IpsPropertyDispatcherFactory())
                        .newOkCancelDialog("Dialog with Property Dispatcher Factory", Handler.NOP_HANDLER,
                                           Handler.NOP_HANDLER, new AvailableValuesSectionPmo())
                        .open();
    }
