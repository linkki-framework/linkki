...
import org.linkki.samples.playground.ts.components.HeadlineLayout;
import org.linkki.samples.playground.ts.components.InfoToolsComponentLayout;
...
import org.linkki.samples.playground.ts.linkkitheme.NestedFlexItemComponent;
    ...
    public TestScenarioView() {
        ...
        tabLayout.addTabSheets(
                               ...
                               TestScenario.id(TS007)
                                       ...
                                       .testCase(TC003, NestedFlexItemComponent::create)
                                       .createTabSheet(),
                               ...
                               TestScenario.id(TS010)
                                       ...
                                       .testCase(TC003, HeadlineLayout::new)
                                       .testCase(TC004, InfoToolsComponentLayout::new)
                                       .createTabSheet(),
