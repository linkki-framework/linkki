...
@UISection
public class NewBindTooltipPmo {

    private String tooltipText = "This field has a tooltip that changes dynamically with the content of this textfield";
    ...
    @BindTooltip(tooltipType = TooltipType.STATIC, value = "A nice static tooltip", position = BOTTOM)
    public String getTooltipStaticText() {
        return "This field has a static tooltip that cannot be changed with position bottom";
    }

    @UITextField(position = 23, label = "Static Tooltip with Delays")
    @BindTooltip(tooltipType = TooltipType.STATIC, value = "A nice static tooltip", hoverDelay = 1000, focusDelay = 2000, hideDelay = 3000, position = BOTTOM)
    public String getTooltipStaticTextDelays() {
        return "This field has a static tooltip with hover delay = 1000ms, focus delay = 2000ms and hide delay = 3000ms";
    }
}