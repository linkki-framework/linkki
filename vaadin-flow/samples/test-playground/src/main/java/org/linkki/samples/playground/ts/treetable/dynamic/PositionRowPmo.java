...
package org.linkki.samples.playground.ts.treetable.dynamic;
...
import org.linkki.samples.playground.ts.treetable.dynamic.Player.Position;
...
public class PositionRowPmo extends CategoryRowPmo<Player, PlayerRowPmo> {
    ...
    public PositionRowPmo(Supplier<Stream<Player>> playerSupplier, Position position) {
        super(playersByPosition(playerSupplier, position),
                (players) -> players.sorted(Comparator.comparing(Player::getLastName)),
                PlayerRowPmo::new);
