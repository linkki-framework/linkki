...
import org.linkki.samples.playground.binding.annotation.UIRadioButtonGroup.UIRadioButtonGroupBoundPropertyCreator;
import org.linkki.samples.playground.binding.annotation.UIRadioButtonGroup.UIRadioButtonGroupComponentDefinitionCreator;
import org.linkki.samples.playground.binding.annotation.UIRadioButtonGroup.UIRadioButtonGroupFieldAspectDefinitionCreator;
...
public @interface UIRadioButtonGroup {
    ...
    public static class UIRadioButtonGroupComponentDefinitionCreator
        ...
        public LinkkiComponentDefinition create(UIRadioButtonGroup annotation, AnnotatedElement annotatedElement) {
            return new UIRadioButtonGroupComponentDefinition();
        }
    }
    ...
    public class UIRadioButtonGroupFieldAspectDefinitionCreator implements AspectDefinitionCreator<UIRadioButtonGroup> {
        ...
        public LinkkiAspectDefinition create(UIRadioButtonGroup annotation) {
            ...
            AvailableValuesAspectDefinition<?> availableValuesAspectDefinition =
                    new AvailableValuesAspectDefinition<RadioButtonGroup<Object>>(
                            annotation.content(),
                            RadioButtonGroup<Object>::setItems);
