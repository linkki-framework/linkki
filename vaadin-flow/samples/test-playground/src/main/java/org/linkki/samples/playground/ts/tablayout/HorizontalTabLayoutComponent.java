...
public class HorizontalTabLayoutComponent extends Div {
    ...
    public HorizontalTabLayoutComponent() {
        ...
        horizontalSheet.addTabSheet(LinkkiTabSheet.builder("tab1")
                .caption("Horizontal")
                .description("Horizontal tab with string caption")
                .content(() -> createSpan("content1", "This is a horizontal LinkkiTabLayout."))
                .build());
        horizontalSheet.addTabSheet(LinkkiTabSheet.builder("tab2")
