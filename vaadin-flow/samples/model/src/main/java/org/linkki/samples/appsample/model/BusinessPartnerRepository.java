...
public interface BusinessPartnerRepository {
    ...
    /**
     * Returns all {@link BusinessPartner} whose data (e.g. name, address etc.) matches the given
     * search term.
     * 
    ...
    /**
     * Saves the given {@link BusinessPartner}, i.e. adds it to the repository if its a new partner
     * or updates an existing partner.
     * 
