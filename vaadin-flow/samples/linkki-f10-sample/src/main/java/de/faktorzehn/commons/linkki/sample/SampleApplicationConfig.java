...
import de.faktorzehn.commons.linkki.sample.confirm.SampleBrowserConfirmationView;
import de.faktorzehn.commons.linkki.sample.search.contextdependent.ContextDependentSearchView;
import de.faktorzehn.commons.linkki.sample.search.contextfree.ContextFreeSearchView;
...
public class SampleApplicationConfig implements ApplicationConfig {
    ...
    public Sequence<ApplicationMenuItemDefinition> getMenuItemDefinitions() {
        return Sequence.of(new ApplicationMenuItemDefinition("Sample", "sample", SampleUi.class),
                           new ApplicationMenuItemDefinition("Board", "board", SampleBoardLayout.class),
