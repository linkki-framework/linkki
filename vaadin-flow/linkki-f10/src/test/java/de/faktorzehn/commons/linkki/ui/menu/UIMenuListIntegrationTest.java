...
class UIMenuListIntegrationTest {
    ...
    void testMenuList_IconAppliedToMenuItem() {
        ...
        Icon icon = (Icon)theItem.getChildren().collect(Collectors.toList()).get(0);
    ...
    void testMenuList_MenuItemsCreated() {
        ...
        Icon icon1 = (Icon)subItems.get(0).getChildren().collect(Collectors.toList()).get(0);
    ...
    private Condition<? super MenuItem> anIcon() {
        return new Condition<>(menuItem -> menuItem.getChildren().anyMatch(Icon.class::isInstance),
