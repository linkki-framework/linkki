...
public class MenuItemDefinition {
    ...
    /**
     * Creates a new menu item without an icon that executes the given command on click.
     *
     * @param caption displayed text of the menu item
     * @param command command to execute on click
     * @deprecated Use {@link #MenuItemDefinition(String, VaadinIcon, Handler, String)} instead
     */
    @Deprecated(since = "22.6.0")
    public MenuItemDefinition(String caption, Handler command) {
        this(caption, null, command);
    }
