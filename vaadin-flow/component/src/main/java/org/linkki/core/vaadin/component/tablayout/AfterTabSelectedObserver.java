 ...
 * <p>
 * The event is only propagated to components which are attached and visible at the time the
 * selection listeners are triggered. That means components that are added or become visible within
 * this observer will not receive the current event, even if they also implement this interface.
 * <p>
