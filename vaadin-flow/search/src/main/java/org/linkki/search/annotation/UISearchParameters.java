...
/**
 * Creates a layout that contains elements that are defined in the PMO returned by the annotated
 * member.
 * 
 * @since 2.8.0
 */
...
public @interface UISearchParameters {
    ...
    class FlexLayoutComponentDefinitionCreator implements ComponentDefinitionCreator<UISearchParameters> {
        @Override
