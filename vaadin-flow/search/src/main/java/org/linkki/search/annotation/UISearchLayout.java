...
/**
 * Creates a {@link SearchLayout} from the annotated PMO.
 *
 * @since 2.8.0
 */
...
public @interface UISearchLayout {
    ...
    class SearchComponentDefinitionCreator implements ComponentDefinitionCreator<UISearchLayout> {
        @Override
    ...
    class SearchLayoutDefinitionCreator implements LayoutDefinitionCreator<UISearchLayout> {
