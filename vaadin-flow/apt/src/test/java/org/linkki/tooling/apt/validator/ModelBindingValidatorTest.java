...
public class ModelBindingValidatorTest extends BaseAnnotationProcessorTest {
    ...
    class CompilationSuccess {
        ...
        @Test
        @DisplayName("ignore failures by option")
        void shouldIgnoreFailures() {
            addLinkkiAptOption(ModelBindingValidator.MISSING_MODEL_OBJECT, "IGNORE");
            List<SourceFile> sources = getSourceFiles("ReportType.java",
                                                      "Report.java",
                                                      "modelBindingValidator/ModelObjectMissingPmo.java");
