...
/**
 * Base class for validating a method-scoped annotation. The annotation must not be
...
public abstract class MethodAnnotationValidator<T extends Annotation> implements Validator {
     ...
     * <p>
     * Class fields of the annotation should not be accessed, as they can reference custom classes
     * which are not loaded when running APT.
     * 
