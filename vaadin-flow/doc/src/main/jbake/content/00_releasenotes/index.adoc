...
//
// | Vaadin                        | 24.9.12 (link:https://github.com/vaadin/platform/releases/tag/24.9.12[Release Notes]) | 24.9.10
// | Spring Boot compatibility tested for | 3.5.11 (link:https://github.com/spring-projects/spring-boot/releases/tag/v3.5.11[Release Notes]) | 3.5.10
...
| Vaadin                        | 24.9.22 (link:https://github.com/vaadin/platform/releases/tag/24.9.22[Release Notes]) | 24.9.20
...
| Vaadin                        | 24.9.20 (link:https://github.com/vaadin/platform/releases/tag/24.9.20[Release Notes]) | 24.9.19
| Faktor-IPS                    | 26.1.4.release (link:https://doc.faktorzehn.org/faktor-ips/26.1/[Release Notes]) | 26.1.3.release

|===

==== Bugfixes

// https://jira.convista.com/browse/LIN-4665
* *Placeholder text color not visible in dark mode* +
The empty state text color used for placeholders was not defined as a theme variable, causing insufficient contrast in dark mode.
...
| Vaadin                        | 24.9.19 (link:https://github.com/vaadin/platform/releases/tag/24.9.19[Release Notes]) | 24.9.18
|===

WARNING:: Note that the Vaadin version used by this version needs commercial support.
If you are a customer of Faktor Zehn and you are having any problems, please contact your Faktor Zehn representative.

==== Bugfixes

// https://jira.convista.com/browse/JTS-3376
* *Testbench tests not closing Chrome handles in headless mode* +
Executing <<ui-testing, UI tests>> in headless mode spawned two ChromeDriver instances but only closed one at the end of each test.
...
| Spring Boot compatibility tested for | 3.5.16 (link:https://github.com/spring-projects/spring-boot/releases/tag/v3.5.16[Release Notes]) | 3.5.15
| Faktor-IPS                    | 26.1.3.release (link:https://doc.faktorzehn.org/faktor-ips/26.1/[Release Notes]) | 26.1.2.release
|===
...
| Vaadin                        | 24.9.18 (link:https://github.com/vaadin/platform/releases/tag/24.9.18[Release Notes]) | 24.9.17
| Spring Boot compatibility tested for | 3.5.15 (link:https://github.com/spring-projects/spring-boot/releases/tag/v3.5.15[Release Notes]) | 3.5.14
|===
...
| Vaadin                        | 24.9.17 (link:https://github.com/vaadin/platform/releases/tag/24.9.17[Release Notes]) | 24.9.14
| Spring Boot compatibility tested for | 3.5.14 (link:https://github.com/spring-projects/spring-boot/releases/tag/v3.5.14[Release Notes]) | 3.5.13
|===
...
| Faktor-IPS                    | 26.1.2.release (link:https://doc.faktorzehn.org/faktor-ips/26.1/[Release Notes]) | 26.1.1.release
|===
...
| Vaadin                        | 24.9.14 (link:https://github.com/vaadin/platform/releases/tag/24.9.14[Release Notes]) | 24.9.13
| Spring Boot compatibility tested for | 3.5.13 (link:https://github.com/spring-projects/spring-boot/releases/tag/v3.5.13[Release Notes]) | 3.5.11
|===
...
In version 2.9.2, `UIDateField` and `UIDateTimeField` create components with a clear button by default.
...
// https://jira.convista.com/browse/LIN-4713
* *BindClearButton* +
A new aspect annotation <<bind-clear-button, @BindClearButton>> has been added to set a clear button visibility on UI components that implement `HasClearButton` interface.
...
| Vaadin                        | 24.9.13 (link:https://github.com/vaadin/platform/releases/tag/24.9.13[Release Notes]) | 24.9.12
| Faktor-IPS                    | 26.1.1.release (link:https://doc.faktorzehn.org/faktor-ips/26.1/[Release Notes]) | 26.1.0.release
|===
...
See the https://vaadin.com/docs/v24/flow/advanced/downloads[Vaadin documentation] for details.
