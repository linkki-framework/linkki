...
This version adds support for returning multiple PMOs as a `SequencedCollection<Object>` in the `UINestedComponent` annotation. See <<multiple-nested-pmos, chapter "Nested Components">> for more information.
