...
| Logback                    | 1.5.29 | 1.5.21
| Spring Boot compatibility tested for | 3.5.10 (link:https://github.com/spring-projects/spring-boot/releases/tag/v3.5.10[Release Notes]) | 3.5.8
|===
