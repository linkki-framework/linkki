...
This patch version updates the Vaadin version to the latest Vaadin 24 version, which has a prolonged maintenance support. As this update contains API changes despite being in a patch release, the version number is set to 101.
...
| Vaadin                        | 24.9.9 (link:https://github.com/vaadin/platform/releases/tag/24.9.9[Release Notes]) | 24.5.14
| Spring Boot                   | 3.5.9 (link:https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-3.5-Release-Notes[Release Notes])    | 3.4.12
| Logback                       | 1.5.24    | 1.5.21
|===

The update to Vaadin 24.9.9 brings some notable changes:
