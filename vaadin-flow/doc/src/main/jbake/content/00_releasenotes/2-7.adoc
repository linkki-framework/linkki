...
//
// | Vaadin                        | 24.9.12 (link:https://github.com/vaadin/platform/releases/tag/24.9.12[Release Notes]) | 24.9.11
...
| Spring Boot                   | 3.5.14 (link:https://github.com/spring-projects/spring-boot/releases/tag/v3.5.14[Release Notes])    | 3.5.13
|===
...
| Spring Boot                   | 3.5.13 (link:https://github.com/spring-projects/spring-boot/releases/tag/v3.5.13[Release Notes])    | 3.5.11
|===
...
| Vaadin                        | 24.9.12 (link:https://github.com/vaadin/platform/releases/tag/24.9.12[Release Notes]) | 24.9.11
| Spring Boot                   | 3.5.11 (link:https://github.com/spring-projects/spring-boot/releases/tag/v3.5.11[Release Notes])    | 3.5.10
| Logback                       | 1.5.32    | 1.5.28
|===

=== Version 2.7.101

This patch version updates the Vaadin version to the latest Vaadin 24 version, which has a prolonged maintenance support.
As this update contains API changes despite being in a patch release, the version number is set to 101.
...
| Vaadin                        | 24.9.11 (link:https://github.com/vaadin/platform/releases/tag/24.9.11[Release Notes]) | 24.5.14
| Spring Boot                   | 3.5.10 (link:https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-3.5-Release-Notes[Release Notes])    | 3.4.12
| Logback                       | 1.5.28    | 1.5.21
|===

The update to Vaadin 24.9.11 brings some notable changes:
...
* [.api-change]*Anchor#setHref(AbstractStreamResource) has been deprecated.* +
Therefore, LinkkiAnchor#setHref(AbstractStreamResource) has been deprecated as well and is marked for removal.
...
| Spring Boot     | 3.4.12 (link:https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-3.4-Release-Notes[Release Notes])    | 3.4.11
...
| Spring Boot                   | 3.4.11 (link:https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-3.4-Release-Notes[Release Notes])    | 3.4.9
|===

==== Bugfixes

// https://jira.convista.com/browse/LIN-4561
* In version `2.7.5`, entering a value to a cell inside a table created with `@UITableComponent` and traversing with the tab-key results in loosing focus.
