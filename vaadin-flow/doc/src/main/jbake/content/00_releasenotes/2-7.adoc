...
| Vaadin                        | 24.9.17 (link:https://github.com/vaadin/platform/releases/tag/24.9.17[Release Notes]) | 24.9.13
| Spring Boot                   | 3.5.14 (link:https://github.com/spring-projects/spring-boot/releases/tag/v3.5.14[Release Notes])    | 3.5.11
|===
