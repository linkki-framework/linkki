...
| Vaadin                        | 24.9.10 (link:https://github.com/vaadin/platform/releases/tag/24.9.10[Release Notes]) | 24.5.14
...
The update to Vaadin 24.9.10 brings some notable changes:
