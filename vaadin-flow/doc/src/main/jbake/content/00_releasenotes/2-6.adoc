...
// https://jira.convista.com/browse/LIN-4634
* In version `2.6.5` and `2.6.6`, the linkki-bom was published incorrectly and did not contain any `dependencyManagement` entries.
This issue affects only versions `2.6.5` and `2.6.6`.
Starting with `2.6.7`, the BOM has been fixed and works as expected.
...
| Spring Boot | 3.3.13 | 3.3.12
| Netty | 4.1.127.Final | 4.1.121.Final
| Faktor-IPS | 24.7.9.release | 24.7.8.release
|===
