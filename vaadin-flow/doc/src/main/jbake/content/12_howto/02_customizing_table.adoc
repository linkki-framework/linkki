...
[NOTE]
This section refers to table and row PMOs (<<databinding, *Presentation Model Object* (PMO)>>) and assumes that you are familiar with the <<linkki-tutorial, *linkki tutorial*>>.
