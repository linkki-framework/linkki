...
The default is `NONE`.
See the https://vaadin.com/api/platform/com/vaadin/flow/component/combobox/MultiSelectComboBox.AutoExpandMode.html[Vaadin API documentation] for available values.
