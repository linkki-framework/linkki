...
The annotation `@UIBadge` creates a badge for displaying visually highlighted information and corresponds to a badge styled with https://vaadin.com/docs/latest/components/badge[Vaadin's badge theme variants].
