...
Note that link:https://vaadin.com/docs/v24/building-apps/deep-dives/presentation-layer/server-push[server push] should be enabled if the changes should be reflected to the UI immediately.
