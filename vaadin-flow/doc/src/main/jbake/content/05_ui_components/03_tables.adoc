...
Note that link:https://vaadin.com/docs/v24/flow/advanced/server-push[server push] should be enabled if the changes should be reflected to the UI immediately. Otherwise, the changes are shown with the next server roundtrip.
