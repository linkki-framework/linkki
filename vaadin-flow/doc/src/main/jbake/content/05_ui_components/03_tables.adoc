...
If link:https://vaadin.com/docs/latest/advanced/server-push[server push] is enabled, the rows of the table are fetched asynchronously. This is particularly useful if the rows of the table are being retrieved form external systems.
