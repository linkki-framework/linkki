...
[NOTE]
The https://vaadin.com/docs/v24/flow/routing/lifecycle[Vaadin Navigation Lifecycle] documentation proposes the usage of the `AfterNavigationEvent` to initialise the UI.
