...
The favicon can be set in the https://vaadin.com/docs/v25/flow/advanced/modifying-the-bootstrap-page/#the-appshellconfigurator-configurepage-method[AppShellConfigurator] by adding the favicon in the method `configurePage`.
