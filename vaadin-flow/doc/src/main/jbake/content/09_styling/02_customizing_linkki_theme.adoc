...
For general information, see the https://vaadin.com/docs/v24/styling/application-theme[Vaadin documentation on application themes].
...
The style properties can be modified to change the styling either globally, or in a certain scope. https://vaadin.com/docs/v24/styling/styling-components#styling-components-with-style-properties[Vaadin documentation] provides some examples on how to customize the style properties. As linkki theme is based on the Lumo theme, all https://vaadin.com/docs/v24/styling/lumo/lumo-style-properties#lists-of-lumo-style-properties[Lumo style properties] are also available.
