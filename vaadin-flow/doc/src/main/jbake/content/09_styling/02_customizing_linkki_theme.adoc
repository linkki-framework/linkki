...
https://vaadin.com/docs/v25/styling/themes/lumo/lumo-style-properties/typography[Lumo default font family] is modified to make sure that Segoe UI as system font is preferred over Roboto font.
