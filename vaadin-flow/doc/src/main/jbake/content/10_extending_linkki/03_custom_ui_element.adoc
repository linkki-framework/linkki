...
|===
|`AvailableValuesAspectDefinition`| Defines an aspect that updates the set of available values of https://vaadin.com/api/platform/{vvaadin}/com/vaadin/flow/data/provider/HasListDataView.html[HasListDataView].
