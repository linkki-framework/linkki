...
`linkki-core-nestedcomponent-vaadin-flow` contains the following additional features:

* <<nested-pmos, Nested component>>

[source,xml]
----
include::{sample-parent-dir}/test-playground/pom.xml[tags=linkki-core-nestedcomponent-vaadin-flow]
----
