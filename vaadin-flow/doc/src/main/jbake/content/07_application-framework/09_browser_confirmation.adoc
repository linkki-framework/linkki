...
Further relevant information regarding the https://vaadin.com/docs/v24/flow/routing/lifecycle[Navigation Lifecycle] can be found within the Vaadin documentation.
