...
As you may have noticed, you can add an empty address to the address table. This can be considered invalid, and it can be avoided by using <<validation, Validation>>, which is a way to tell the user whether the input fits the domain model logic.
