...
This is a step-by-step tutorial to implement a simple https://linkki-framework.org/index.html[linkki] application with https://spring.io/projects/spring-boot[Spring Boot].
...
image::{images}99_tutorial/business_partner_view_with_result.png[]
...
image::{images}99_tutorial/address.png[]
