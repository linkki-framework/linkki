...
[NOTE]
You do not need to use `AbstractPage`. Here, it is convenient because it will convert your PMOs to Vaadin components. Instead, you could also use a layout such as <<howto-integrating-pmos, `VerticalLayout`>>.
