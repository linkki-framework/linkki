 ...
 * <p>
 * When building the frontend bundle, Vaadin uses a bytecode scanner to locate required dependencies.
 * This test verifies the scanner works with a class structure typical for applications built with
 * linkki.
 */
