...
public class LinkkiComponentUtil {
    ...
    /**
     * Prevents {@link Key#ENTER} to trigger button shortcut in the given component. This is useful
     * for multi-line components in which enter should only add a new line.
     */
