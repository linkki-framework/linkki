...
public enum PlaceholderType {
    ...
    /**
     * Linkki decides whether the placeholder is {@link #DYNAMIC} or {@link #STATIC}. In case the
     * value is the empty string it calls a method named {@code get<PropertyName>Placeholder()}.
     * Otherwise the specified value is used as placeholder.
     */
    AUTO;
}
