 ...
 * {@link UILabel} can return an instance of this class to display HTML content. Instances of this
 * class can be created with an {@link HtmlContentBuilder} using the {@link #builder()} method.
 * 
 * @since 2.5.0
 */
public final class HtmlContent {
     ...
     * Application supplied strings should be sanitized before they are displayed in the UI. <b>This
     * method should not be used to display content which was entered by the user.</b>
     * <p>
     ...
     * @param style the inline CSS style to apply to the element, e.g., "color: red; font-size:
     *            14px;"
     * @param content the content to be enclosed within the HTML element
     * @return an instance of HtmlContent representing the HTML element with the specified tag,
     *         style, and content
     */
     ...
     * 
     * @return an instance of {@link HtmlContent} representing the HTML element with the specified
     *         icon
     */
    ...
    /**
     * Escapes the given HTML text, meaning the input of this method will not be interpreted as
     * HTML.
     * <p>
    ...
    /**
     * Creates an HTML content element for displaying multiple lines of text within a
     * {@literal <div>} container.
     *
     * This method takes a variable number of strings as input and generates an HTML
     * {@literal <div>} element containing the provided lines of text. Each input string represents
     * a line of text, and the method will insert a line break ({@literal <br>
     ...
     * {@link org.linkki.core.defaults.ui.element.ItemCaptionProvider} will pick this method to
     * display the content.
     */
    @Override
