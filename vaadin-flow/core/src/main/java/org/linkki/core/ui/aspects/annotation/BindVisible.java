...
/**
 * This aspect annotation sets the visibility of a component to {@link VisibleType#DYNAMIC}, determining
 * its visibility by calling the <b>is[PropertyName]Visible()</b> method.
 * <p>
 * If used on a {@link ContainerPmo}, the visibility of the surrounding {@link UISection} is set instead
 * of the table's visibility.
 */
