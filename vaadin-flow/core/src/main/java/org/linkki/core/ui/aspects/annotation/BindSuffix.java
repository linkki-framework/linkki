...
/**
 * BindSuffix can add a suffix to UI elements which support the {@link HasSuffix} interface. Common
 * UI elements which supports BindSuffix are {@link UIIntegerField}, {@link UIDoubleField},
