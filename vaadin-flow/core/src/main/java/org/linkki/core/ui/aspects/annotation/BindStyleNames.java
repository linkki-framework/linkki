...
public @interface BindStyleNames {
    /**
     * The style names that may be used in CSS as style classes. Multiple style names could be
     * provided like <code>@BindStyleNames({ STYLE_NAME_1, STYLE_NAME_2 })</code>
     * <p>
     ...
     * {@code get<PropertyName>StyleNames} which may return a {@link String} or {@link Collection}
     * of {@link String}.
     * 
     * @see HasStyle#setClassName(String)
     */
