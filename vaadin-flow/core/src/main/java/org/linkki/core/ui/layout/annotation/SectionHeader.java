 ...
 * {@link UISection}.
 * <p>
 * It is recommended to use negative numbers for the position of elements marked with this
 * annotation to avoid conflicts with elements placed in the section's content area.
 * 
