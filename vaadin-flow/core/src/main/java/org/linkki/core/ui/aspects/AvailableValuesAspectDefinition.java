...
public class AvailableValuesAspectDefinition<C> implements LinkkiAspectDefinition {
    ...
    /**
     * Returns an {@link Aspect} with name {@link AvailableValuesAspectDefinition#NAME}. The value
     * of this {@link Aspect} is created in dependence on the current {@link AvailableValuesType}.
     *
    ...
    /**
     * Handles <code>null</code> values in the list of available values that is about to be set to
     * the component. By default, the items list is directly passed to the {@link ComponentWrapper}
     ...
     * @param items items to be shown in the {@link ComponentWrapper}. May contain
     *            <code>null</code>.
     */
