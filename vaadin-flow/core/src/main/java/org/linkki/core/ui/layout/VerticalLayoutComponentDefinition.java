...
public class VerticalLayoutComponentDefinition implements LinkkiComponentDefinition {
     ...
     * Vertically, all components are middle aligned. The state of spacing and padding can be
     * applied. When activ then predefined style will apply to the layout. By default padding is
     * activated and spacing is activated.
     */
